package com.subscription.SubscriptionBootstrapModule.subscriptionmanagement.model;
...
public class Subscription implements Serializable {
    ...
    public Subscription(final UUID subID,final String paymentMode , final UUID planId , final UUID userId, boolean isBonus) {
        this.subID = subID;
    ...
    public void update(Subscription newSubscription) {
        ...
        this.setPaymentMode(newSubscription.getPaymentMode());
    }
}
