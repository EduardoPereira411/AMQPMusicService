...
public class AMQPConfig {
	...
	public DirectExchange exchange() {
		return new DirectExchange(userBootstrapEx);
	}
	...
	@Bean
	public Binding bindingBootstrapUsers() {
		return BindingBuilder.bind(bootstrapUserQueue()).to(exchange()).with(userBootstrapKey);
	}
