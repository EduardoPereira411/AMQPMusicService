package com.plan.PlanCommandModule.planmanagement.model;
...
public class Plan {
    ...
    //creates plan normally
    public Plan(String planName,Integer minutes, Double monthlyFee, Double annualFee, Integer deviceNr, Integer musicCollectionsNr, String musicRecommendation) {
        this.planID = UUID.randomUUID();
    ...
    //create plan coming from rabbit
    public Plan(UUID id, String planName,Integer minutes, Double monthlyFee, Double annualFee, Integer deviceNr, Integer musicCollectionsNr, String musicRecommendation) {
        this.planID = id;
        setPlanName(planName);
        this.minutes = minutes;
        this.monthlyFee = monthlyFee;
    ...
    //creates bonus plan normally
    public Plan(String planName,Integer minutes, Double monthlyFee, Double annualFee, Integer deviceNr, Integer musicCollectionsNr, String musicRecommendation, boolean isBonus) {
        this.planID = UUID.randomUUID();
        setPlanName(planName);
        this.minutes = minutes;
        this.monthlyFee = monthlyFee;
    ...
    //create bonus plan coming from rabbit
    ...
    public void deactivatePlan(final long desiredVersion) {
        // check current version
        if (this.version != desiredVersion) {
            throw new StaleObjectStateException("Object was already modified by another user", this.planID);
        }
